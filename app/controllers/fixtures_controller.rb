class FixturesController < ApplicationController
  ...
  def new
    @fixture = Fixture.new
    if params[:room_id]
      @fixture.room_id = params[:room_id]
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @fixture.save
        format.html { redirect_to fixtures_url, notice: 'Fixture was successfully created.' }
  ...
  private
    ...
    def fixture_params
      params.require(:fixture).permit(:asset, :classification, :notes, :room_id)
    end
end
