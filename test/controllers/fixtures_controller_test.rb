...
class FixturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post fixtures_url, params: { fixture: { asset: @fixture.asset, notes: @fixture.notes, type: @fixture.type } }
    end
  ...
  test "should update fixture" do
    patch fixture_url(@fixture), params: { fixture: { asset: @fixture.asset, notes: @fixture.notes, type: @fixture.type } }
